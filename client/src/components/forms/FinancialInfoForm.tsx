                  ...
                  <div className="relative">
                    ...
                    <label
                      className={`absolute left-3 -top-2.5 bg-white px-1 text-sm transition-all
                        ...
                        ${errors.employmentStatus && touched.employmentStatus ? 'text-red-500' : 'text-gray-500'}
                        pointer-events-none
                      `}
                    >
                  ...
                  <div className="relative">
                    ...
                    <label
                      className={`absolute left-3 -top-2.5 bg-white px-1 text-sm transition-all
                        peer-placeholder-shown:top-2 peer-placeholder-shown:text-base
                        peer-focus:-top-2.5 peer-focus:text-sm
                        ${errors.additionalInvestments && touched.additionalInvestments ? 'text-red-500' : 'text-gray-500'}
                        pointer-events-none
                      `}
                    >
